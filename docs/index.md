...
hero:
  ...
  tagline: "HTTP caching for Python — RFC-compliant, transport-agnostic, streaming-friendly"
  actions:
    - theme: brand
      text: Get Started
      link: /quickstart
...
features:
  - icon: 🔌
    ...
    details: Ships with pure-python RFC-compliant state machine for HTTP caching.
  - icon: 🧩
